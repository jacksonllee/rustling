...
The :class:`~rustling.chat.CHAT` class can convert CHAT data to other annotation formats.
...
:meth:`~rustling.chat.CHAT.to_elan` converts CHAT data to an
...
use :meth:`~rustling.chat.CHAT.to_elan_strs`:
...
:meth:`~rustling.chat.CHAT.to_srt` converts CHAT data to an
...
use :meth:`~rustling.chat.CHAT.to_srt_strs`:
...
:meth:`~rustling.chat.CHAT.to_textgrid` converts CHAT data to a
...
To get TextGrid strings in memory, use :meth:`~rustling.chat.CHAT.to_textgrid_strs`:
...
:meth:`~rustling.chat.CHAT.to_conllu` converts CHAT data to a
...
To get CoNLL-U strings in memory, use :meth:`~rustling.chat.CHAT.to_conllu_strs`:
